...
namespace Tutorial {
    ...
    public partial class dsPersona : global::System.Data.DataSet {
        ...
        public partial class PersonaDataTable : global::System.Data.TypedTableBase<PersonaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonaRow AddPersonaRow(int id, string Nombre, string Apellidos, string fechaNacimiento) {
...
namespace Tutorial.dsPersonaTableAdapters {
    ...
    public partial class PersonaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Persona] WHERE (([id] = @Original_id) AND ([Nombre] = @Origina" +
                "l_Nombre) AND ([Apellidos] = @Original_Apellidos) AND ((@IsNull_fechaNacimiento " +
                "= 1 AND [fechaNacimiento] IS NULL) OR ([fechaNacimiento] = @Original_fechaNacimi" +
                "ento)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Persona] ([id], [Nombre], [Apellidos], [fechaNacimiento]) VALU" +
                "ES (@id, @Nombre, @Apellidos, @fechaNacimiento);\r\nSELECT id, Nombre, Apellidos, " +
                "fechaNacimiento FROM Persona WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Persona] SET [id] = @id, [Nombre] = @Nombre, [Apellidos] = @Apellidos, [fechaNacimiento] = @fechaNacimiento WHERE (([id] = @Original_id) AND ([Nombre] = @Original_Nombre) AND ([Apellidos] = @Original_Apellidos) AND ((@IsNull_fechaNacimiento = 1 AND [fechaNacimiento] IS NULL) OR ([fechaNacimiento] = @Original_fechaNacimiento)));
SELECT id, Nombre, Apellidos, fechaNacimiento FROM Persona WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Tutorial.Properties.Settings.Default.TutorialConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Nombre, Apellidos, fechaNacimiento FROM dbo.Persona";
        ...
        public virtual int Fill(dsPersona.PersonaDataTable dataTable) {
        ...
        public virtual dsPersona.PersonaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsPersona.PersonaDataTable dataTable = new dsPersona.PersonaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsPersona.PersonaDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_Nombre, string Original_Apellidos, string Original_fechaNacimiento) {
        ...
        public virtual int Insert(int id, string Nombre, string Apellidos, string fechaNacimiento) {
        ...
        public virtual int Update(int id, string Nombre, string Apellidos, string fechaNacimiento, int Original_id, string Original_Nombre, string Original_Apellidos, string Original_fechaNacimiento) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellidos, string fechaNacimiento, int Original_id, string Original_Nombre, string Original_Apellidos, string Original_fechaNacimiento) {
            return this.Update(Original_id, Nombre, Apellidos, fechaNacimiento, Original_id, Original_Nombre, Original_Apellidos, Original_fechaNacimiento);
        }
    }
